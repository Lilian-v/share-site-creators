...
:build_acs
	...
	call %MVN_EXEC% clean package -pl share-site-creators-integration-tests,share-site-creators-repo,share-site-creators-platform-docker
EXIT /B 0
:tail
...
EXIT /B 0
:prepare-test
    call %MVN_EXEC% verify -DskipTests=true -pl share-site-creators-repo,share-site-creators-integration-tests,share-site-creators-platform-docker
EXIT /B 0
:test
    call %MVN_EXEC% verify -pl share-site-creators-repo,share-site-creators-integration-tests
EXIT /B 0
:purge
